Vagrant::Config.run do |config|
  ...
  config.vm.provision :chef_server do |chef|
    chef.node_name = "vagrant-geniverse"
    ...
    chef.add_role("geniverse_server")
    ...
    chef.json.merge!({
      ...
      :geniverse_server => {
        :resources  => { :root => "/vagrant/resources" },
        :gwt        => { :root => "/vagrant/gwt" },
        :chat       => { :root => "/vagrant/chat" },
        :sproutcore => { :root => "/vagrant/sproutcore" },
        :portal     => { :root => "/vagrant/portal" },
        :rails      => { :root => "/vagrant/rails" },
      }
    })
  end
